...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_resstaurantId_fkey" FOREIGN KEY ("resstaurantId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
